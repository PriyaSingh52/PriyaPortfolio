...
const experience = [
  {
    ...
    description:
      "Working as a Frontend Developer building scalable web applications. Contributed to projects like DCM Suvidha and SOSTOS, focusing on performance, UI/UX, and production stability.",
    achievements: [
      "Built DCM Suvidha Admin Panel with full CRUD functionality using React.js, TypeScript, and Refine CMS",
      "Contributed to the SOSTOS project by improving UI performance and resolving production issues",
      "Integrated Supabase backend for secure and scalable data handling",
      "Designed responsive and user-friendly interfaces to enhance user experience",
      "Managed UAT and production issues, ensuring smooth deployment cycles",
      "Deployed applications to UAT and production environments",
      "Received recognition for performance and contributions at the start of the month",
    ],
  },
  {
    ...
    description:
      "Worked as a Web Developer Intern focusing on full-stack development and responsive UI design.",
    achievements: [
      "Created an NGO website using HTML, Tailwind CSS, and JavaScript",
      "Built a School Management System using PHP and MySQL",
      "Implemented responsive UI to improve user experience",
